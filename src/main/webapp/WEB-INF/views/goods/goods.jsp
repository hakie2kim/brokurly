      ...
      <div class="goods-2">
        <main class="goods-3">
          ...
          <section class="goods-28">
            ...
            <span class="goods-45">
                                <span>21,990<!-- -->원</span>
                                <button>?
                                    <svg width="21" height="21" fill="none"></svg>
                                </button>
                            </span>
            <p>원산지: <!-- -->상품설명/상세정보 참조</p>
            <div>로그인 후, 적립 혜택이 제공됩니다.</div>
            <ul>
              <li>
                <dt>배송</dt>
                <dd>
              ...
              <li>
                <dt>소비기한(또는 유통기한)정보</dt>
                <dd>
                  <p>수령일 포함 최소 3일 남은 제품을 보내 드립니다.</p>
                </dd>
              </li>
              <li>
                <dt>안내사항</dt>
                <dd>
                  <p>해당 상품은 냉장 제품입니다 상품 수령 후 최대한 빠른 시일내에 섭취를 권장드립니다.</p>
                </dd>
              </li>
            </ul>
            <div>
                ...
                <li>
                  ...
                  <dd>
                    <div>
                      ...
                      <div>
                        <div>
                          <button type="button" onclick='count("plus")' value='+' aria-label="수량내리기">+</button>
                          <div id="count">1</div>
                          <button type="button" onclick='count("minus")' value='-' aria-label="수량올리기" >-</button>
                        </div>
                        <div>
              ...
              <div>
                <div>
                  <div class="goods-42">
                    <span>총 상품금액 :</span>
                    <span id="sum">19990</span>
                    <span>원</span>
                  </div><div class="goods-43">
                  <span>적립</span>
              ...
              <div>
                <button onclick="heartToggle()" width="56" height="56" radius="3">
                                        <span>
                                            <img src="/resources/image/heartX.png" alt="" class="img1" id="heart">
                                        </span>
                </button>
                <button onclick="bellToggle()" width="56" height="56" radius="3">
                                        <span>
                                            <img src="/resources/image/bellX.png" alt="" class="img1" id="bell">
                                        </span>
                </button>
                <div>
                  <button type="button" radius="3">
                    <span>장바구니 담기</span>
                  </button>
                </div>
              </div>
        ...
        <div>
            ...
            <div>
              <div>
                <div>
                  <div>
                    <div>
                      <img src="https://img-cf.kurly.com/cdn-cgi/image/width=1010,quality=90/shop/data/goodsview/20210804/gv00000208742_1.jpg"> <!--상품설명 이미지-->
                    </div>
                    <div>
                      <h3>
                      ...
                      <p>호불호 없는 메인 요리를 꼽자면 양념 소불고기가 빠지지 않을 거예요. 달짝지근한 양념이 고루 밴 야들한 소불고기는 온 가족 밥반찬으로 딱 좋은 식재료인데요. 컬리는 맛 좋은 소불고기를 부담 없이 즐길 수 있도록 넉넉한 1kg 대용량으로 준비했어요. 육가공 전문 브랜드, 견우푸드와 손 잡고 질 좋은 소고기에 너무 짜거나 달지 않은 은근한 감칠맛을 입혀 완성했답니다. 냉장고에 구비해두고 마땅한 반찬이 떠오르지 않는 순간, 언제든지 꺼내 즐겨보세요. 명절 음식으로 활용하기에도 제격일 거에요.</p>
                    </div>
                  </div>
                  <div>
                    <h3>
          ...
          <div class="goods-19"  id="section2">
            <div>
              <img src="https://img-cf.kurly.com/cdn-cgi/image/width=1010,quality=90/shop/data/goodsview/20230904/gv00000723355_1.jpg" alt="자세히보기 이미지">
            </div>
            <div class="goods-12">
              <h3>상품고시정보</h3>
              <ul class="goods-9">
              ...
              <div class="goods-13">
                ...
                <ul class="goods-85">
                  ...
                  <li class="goods-86">
                    ...
                    <strong class="goods-89 e18xf2bx0">카카오톡에서<!-- --> '<!-- -->컬리<!-- -->' <!-- -->를 검색 후<br>대화창에 문의 및 불편사항을<br>남겨주세요.</strong>
                  </li>
                  <li class="goods-86">
            ...
            <div id="content1">
              <div class="goods-78">
                ...
                <p class="goods-80">받으신 상품이 표시·광고 내용 또는 계약 내용과 다른 경우에는 상품을 받은 날부터 3개월 이내,<!-- --><!-- -->그 사실을 알게 된 날부터 30일 이내에 교환 및 환불을 요청하실 수 있습니다.<!-- --><!-- -->상품의 정확한 상태를 확인할 수 있도록 사진을 함께 보내주시면 더 빠른 상담이 가능합니다.
              ...
              <div class="goods-78">
                ...
                <p class="goods-80">
                  ...
                  상품의 특성상 재판매가 불가하여 단순 변심, 주문 착오, 주소 오입력 등 고객의 책임 있는 사유로 인한 교환 및 반품이 어려운 점 양해 부탁드립니다.<!-- --><!-- -->상품에 따라 조금씩 맛이 다를 수 있으며, 개인의 기호에 따라 같은 상품도 다르게 느끼실 수 있습니다.
            ...
            <div id="content2">
              <div class="goods-78">
                ...
                <p  class="goods-80">- [배송준비중] 부터는 취소가 불가하니, 반품으로 진행해주세요. (상품에 따라 반품이 불가할 수 있습니다.)<!-- --><!-- -->- 주문마감 시간에 임박할수록 취소 가능 시간이 짧아질 수 있습니다.<!-- --><!-- -->- 비회원은 App 또는 모바일 웹사이트에서 [마이컬리 <!-- -->&gt;<!-- --> 비회원 주문조회 페이지] 에서 취소가 가능합니다.<!-- --><!-- -->- 일부 예약상품은 배송 3~4일 전에만 취소 가능합니다.<!-- --><!-- -->- 주문상품의 부분취소는 불가능합니다. 전체 주문 취소 후 다시 구매 해주세요.<!-- --><!-- -->- 미성년자 결제 시 법정대리인이 그 거래를 취소할 수 있습니다.<!-- --></p>
              </div>
              <div class="goods-78">
                <strong class="goods-79">결제 승인 취소 / 환불 관련</strong>
                <p  class="goods-80">- 카드 환불은 카드사 정책에 따르며, 자세한 사항은 카드사에 문의해주세요.<!-- --><!-- -->- 결제 취소 시, 사용하신 적립금과 쿠폰도 모두 복원됩니다.</p>
              </div>
            </div>
            <div class="goods-81">
                ...
                <div class="goods-56">
                  ...
                  <div class="goods-49">
                    <header class="goods-50">
                      <h3>회원 등급</h3>
                      <button type="button">
                        <svg width="12.8" height="12.8" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M13.78 3.96303C12.504 2.16973 10.4086 1 8.04 1C4.15192 1 1 4.15192 1 8.04C1 11.9281 4.15192 15.08 8.04 15.08C11.9281 15.08 15.08 11.9281 15.08 8.04" stroke="#b5b5b5" stroke-width="1.8" stroke-linecap="square" stroke-linejoin="round"></path>
                          <path d="M14.4933 1L14.4933 4.52H10.9733" stroke="#b5b5b5" stroke-width="1.8" stroke-linecap="square" stroke-linejoin="round"></path>
                        </svg>
                        <span>초기화</span>
                      </button>
                    </header>
                        ...
                        <button>
                                                        <span style="box-sizing: border-box; display: inline-block; overflow: hidden; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; position: relative; max-width: 100%;">
                                                            <span style="box-sizing: border-box; display: block; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; max-width: 100%;">
                                                                <img alt="" aria-hidden="true" src="data:image/svg+xml,%3csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20version=%271.1%27%20width=%2793%27%20height=%2793%27/%3e" style="display: block; max-width: 100%; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px;">
                                                            </span>
                                                            <img alt="리뷰 이미지 썸네일" src="https://img-cf.kurly.com/cdn-cgi/image/width=240,height=240,fit=crop,quality=85/shop/data/review/20240129/fa69877c-d25d-4394-9ec1-b0ec002ab97b.jpg" decoding="async" data-nimg="intrinsic" style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 0px; height: 0px; min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%; object-fit: cover;" srcset="https://img-cf.kurly.com/cdn-cgi/image/width=240,height=240,fit=crop,quality=85/shop/data/review/20240129/fa69877c-d25d-4394-9ec1-b0ec002ab97b.jpg 1x, https://img-cf.kurly.com/cdn-cgi/image/width=240,height=240,fit=crop,quality=85/shop/data/review/20240129/fa69877c-d25d-4394-9ec1-b0ec002ab97b.jpg 2x">
                                                        </span>
                        </button>
                      </div>
                      <footer>
                ...
                <div class="goods-17">
                  ...
                  <article>
                    <div>
                      ...
                      <p>집에 또띠아 남은 것과 유통기한이 임박한 사워크림이 있어서 소불고기 사서 퀘사디아 만들어먹었어요. 퀘사디아는 난생 처음 도전해보는데 정말 간단하게 만들 수 있지만 기대 이상으로 맛있어서 레시피 공유해볼게요! 👩‍🍳 </p>
                      <div>
                        <button>
                                                        <span style="box-sizing: border-box; display: inline-block; overflow: hidden; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; position: relative; max-width: 100%;">
                                                            <span style="box-sizing: border-box; display: block; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; max-width: 100%;">
                                                            ...
                                                            <img alt="리뷰 이미지 썸네일" src="https://img-cf.kurly.com/cdn-cgi/image/width=240,height=240,fit=crop,quality=85/shop/data/review/20231219/c41f1d7c-7375-4558-9a78-3b4e31b78f65.jpeg" decoding="async" data-nimg="intrinsic" style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 0px; height: 0px; min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%; object-fit: cover;" srcset="https://img-cf.kurly.com/cdn-cgi/image/width=240,height=240,fit=crop,quality=85/shop/data/review/20231219/c41f1d7c-7375-4558-9a78-3b4e31b78f65.jpeg 1x, https://img-cf.kurly.com/cdn-cgi/image/width=240,height=240,fit=crop,quality=85/shop/data/review/20231219/c41f1d7c-7375-4558-9a78-3b4e31b78f65.jpeg 2x">
                                                        </span>
                        </button>
                        <button>
                                                        <span style="box-sizing: border-box; display: inline-block; overflow: hidden; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; position: relative; max-width: 100%;">
                                                            ...
                                                            <img alt="리뷰 이미지 썸네일" src="https://img-cf.kurly.com/cdn-cgi/image/width=240,height=240,fit=crop,quality=85/shop/data/review/20231219/3632aa82-771f-454e-9e0f-3c5ed414caef.jpeg" decoding="async" data-nimg="intrinsic" style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 0px; height: 0px; min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%; object-fit: cover;" srcset="https://img-cf.kurly.com/cdn-cgi/image/width=240,height=240,fit=crop,quality=85/shop/data/review/20231219/3632aa82-771f-454e-9e0f-3c5ed414caef.jpeg 1x, https://img-cf.kurly.com/cdn-cgi/image/width=240,height=240,fit=crop,quality=85/shop/data/review/20231219/3632aa82-771f-454e-9e0f-3c5ed414caef.jpeg 2x">
                                                        </span>
                        </button>
                      </div>
                      <footer>
...
$('.goods-34').on('click', function(){document.querySelector('.goods-36').classList.toggle('show')});   //하단 상품선택 버튼 기능(숨김)
$('.goods-34').on('click', function(){document.querySelector('.goods-44').classList.toggle('show')});   //하단 상품선택 버튼 기능(숨김)
$('.goods-34').on('click', function(){document.querySelector('.goods-59').classList.toggle('show')});   //하단 상품선택 버튼 기능(숨김)
$('.goods-34').on('click', function(){document.querySelector('.arrow').classList.toggle('down')});      //하단 상품선택 버튼 기능(화살표 아래로 변경)
$('.goods-34').on('click', function(){document.querySelector('.goods-34').classList.toggle('on')});    //하단 상품선택 버튼 기능(하단 구역 설정)

$('.goods-61').on('click', function(){document.querySelector('.goods-49').classList.toggle('show')});   //상품후기 회원등급 필터 버튼
