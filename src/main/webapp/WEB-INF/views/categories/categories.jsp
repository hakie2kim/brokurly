                ...
                <div class="best-itemlist">
                    ...
                    <span style="
                      ...
                      "><img alt="상품 이미지" sizes="100vw" srcset="
                        ...
                        " src="https://img-cf.kurly.com/cdn-cgi/image/fit=crop,width=360,height=468,quality=85/shop/data/goods/1646377916155l0.jpg" decoding="async" data-nimg="fill" class="css-0" style="
                          position: absolute;
                          inset: 0px;
                          box-sizing: border-box;
                          padding: 0px;
                    ...
                    <span class="css-mz5g71 e1c07x481"><svg width="100%" height="100%" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <circle fill="#999" cx="9.15002" cy="6.17871" r="0.75"></circle></svg></span><span class="review-number css-l610kl e1c07x480">${goodsListDto.revCnt}+</span>
                                </div>
