...
<c:set var="loginSession"
       value="${pageContext.request.getSession(false)==null ? '로그인' : pageContext.request.session.getAttribute('loginName')+='님'}"/>
              ...
              ><span class="category-2">카테고리</span>
                ...
                <c:forEach var="item" items="${selectMain}" varStatus="loop">
                  <li class="css-you2kh e1vs1ym83 menuItem1">
                    <div class="css-11n7bn4 e1vs1ym81">
                      <!-- 이미지 파일명 설정 -->
                      <img src="/resources/image/icon-<c:out value="${loop.index + 1}" />.png" alt="${item.exp}"
